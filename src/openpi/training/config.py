...
class LeRobotFrankaDataConfig(DataConfigFactory):
    """
    transform LeRobotLiberoDataConfig to match real Franka dataset based on the comments below.
    """
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_fast_real_franka_low_mem_finetune",
        model=pi0_fast.Pi0FASTConfig(
